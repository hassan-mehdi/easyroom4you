...
if ( ! empty ($front_options['front_slider']['image'][0]) and is_front_page() ) :
	...
	echo "<script>jQuery(function(){ if(jQuery('.camera_wrap').children().length > 1) {	jQuery('.camera_wrap').camera({ loader: '',hover: 'true',time: '3000', navigationHover: 'false',fx: 'scrollHorz' ,barPosition: '', loaderPadding: 0, playPause: 'false',loaderColor: " . "'" . ( $general_options['color'] ? $general_options['color'] : 'deeppink' ) . "'" . ", loaderBgColor: '#ededed', loaderStroke: 3, pagination: true, loaderOpacity:1, height:" . "'" . ( $front_options['front_slider']['height'] ? $front_options['front_slider']['height'] . '%' : '50%' ) . "'" . ", }); } else { jQuery('.camera_wrap').camera({ autoAdvance: false, mobileAutoAdvance: false, navigation: false, playPause: false, pagination: false, height:" . "'" . ( $front_options['front_slider']['height'] ? $front_options['front_slider']['height'] . '%' : '50%' ) . "'" . " , }); } }); </script>";
				...
				if ( $front_options['front_slider']['title'][$i] || $front_options['front_slider']['desc'][$i] ) :
					...
					echo "<div class='slider-text fadeIn'>";
						...
						if ( $front_options['front_slider']['title'][$i] ) :
							...
							echo "<h1 class='slider-title'>" . $front_options['front_slider']['title'][$i] . "</h1>";
						
						endif;
						
						if ( $front_options['front_slider']['desc'][$i] ) :
						
							echo "<p class='slider-description'>" . $front_options['front_slider']['desc'][$i] . "</p>";
			...
			<div class="row">
				...
				<div class="wrapper">
					...
					<section class="last-entries">
						...
						<?php echo "<h2>" . ( $front_options['last_entries']['title'] ? $front_options['last_entries']['title'] : esc_html__('Latest Rooms', 'lupercalia') ) . "</h2>"; ?>
					...
					<section class="home_bottom_section home_bottom_section_first grid-50">
						<img src="<?php the_field("bottom_1_image", 5); ?>">
						<div class="bottom_section_wrapper">
							<h2><?php the_field("bottom_1_title", 5); ?></h2>
							<?php the_field("bottom_1_content", 5); ?>
						</div>
						<a class="bottom_readmore" href="<?php the_field("bottom_1_link", 5); ?>">Read more</a>
					</section>

					<section class="home_bottom_section grid-50">
						<img src="<?php the_field("bottom_2_image", 5); ?>">
						<div class="bottom_section_wrapper">
							<h2><?php the_field("bottom_2_title", 5); ?></h2>
							<?php the_field("bottom_2_content", 5); ?>
						</div>
						<a class="bottom_readmore" href="<?php the_field("bottom_2_link", 5); ?>">Read more</a>
					</section>
